...
export function AppSidebar({ activeTab, onTabChange }: AppSidebarProps) {
  ...
  return (
    <aside className="w-64 shrink-0 border-r border-slate-800/80 bg-slate-950 p-4 text-slate-300 hidden md:flex md:flex-col justify-between h-screen sticky top-0">
