...
export function DashboardStatCards({ totalCustomers = 150, isLoading }: DashboardStatCardsProps) {
  // Calculated mock deltas and breakdown based on seed dataset
  ...
  if (isLoading) {
    return (
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <Skeleton className="h-28 w-full rounded-xl bg-slate-900/80 border border-slate-800" />
        <Skeleton className="h-28 w-full rounded-xl bg-slate-900/80 border border-slate-800" />
        <Skeleton className="h-28 w-full rounded-xl bg-slate-900/80 border border-slate-800" />
      </div>
    );
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      {/* Total Customers */}
      <div className="relative overflow-hidden rounded-xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md transition-all hover:border-slate-700">
        ...
        <div className="mt-3">
          ...
          <div className="mt-2 flex items-center text-xs font-medium text-emerald-400">
            <span>Trend +3.2%</span>
            <span className="ml-1 text-emerald-400">↑ Green</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden rounded-xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md transition-all hover:border-slate-700">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-slate-400">Active Leads</span>
      ...
      <div className="relative overflow-hidden rounded-xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md transition-all hover:border-slate-700">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-slate-400">Contacted This Week</span>
        ...
        <div className="mt-3">
          ...
          <div className="mt-2 flex items-center text-xs font-medium text-rose-400">
            <span>Trend -1.5%</span>
            <span className="ml-1 text-rose-400">↓ Red</span>
          </div>
        </div>
      </div>
    </div>
